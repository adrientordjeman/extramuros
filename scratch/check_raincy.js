...
const inseePrefix = '93062';
const targetCategories = ['boulangerie', 'boucherie', 'butcher', 'fromagerie', 'cheese', 'supermarket', 'supermarche', 'pharmacie', 'restaurant', 'cafe', 'bar', 'pub', 'commerces'];
...
console.log(`Found ${points.length} points in Le Raincy.`);
